...
public class BuffDictionary
{
    ...
    public StatusEffect this[string id]
    {
        get
        {
            ...
            return new StatusEffect("", "", false, 0, 0, 0, 0, 0, new Lazy<SkillInfo>(() => SkillInfo.Empty("")));
        }
    }

    private StatusEffect CreateStatusEffect(Buff value)
    {
        return new StatusEffect(value.Name, value.DisplayName, true, value.Timer, value.MaxTime, value.BuffCharges, value.BuffStacks, value.FlaskSlot, new Lazy<SkillInfo>(() =>
